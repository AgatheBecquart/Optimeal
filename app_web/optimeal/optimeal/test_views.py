...
class TestViews:
    ...
    def test_predict_view_valid_form(self, mock_post, authenticated_client):
        ...
        response = authenticated_client.post(reverse('predict_view'), {'id_jour': '2023-05-01'})
    ...
    def test_predict_view_invalid_form(self, mock_post, authenticated_client):
        response = authenticated_client.post(reverse('predict_view'), {'id_jour': 'invalid_date'})
